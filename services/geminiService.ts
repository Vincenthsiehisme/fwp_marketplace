...
4. **分析撰寫**：
   ...
   - 【禁止句型】嚴禁出現「以系統計算出的喜用神 X 為核心」「為核心」「系統計算」「系統推算」「系統判定」等任何暗示精準計算的措辭，因時辰未定無法做斷言。
   - 【建議句型】請使用「為您挑選」「凝聚」「呼應您的願望」「協助您顯化」等柔性表達；談到五行屬性時用「相應的木屬性能量」而非「您的喜用神」。
   - 語氣定位：水晶顧問為客戶手寫的能量便籤，而非命理排盤報告。
`;
